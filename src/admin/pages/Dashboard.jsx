                ...
                <div className="col">
                    <div className="card h-100 text-dark bg-light shadow-sm border-0">
                        ...
                        <div className="card-body pt-0">
                            ...
                            <Link to="/admin/orders" className="text-dark text-decoration-none small">View Details &rarr;</Link>
                        </div>
                    </div>
                </div>
                <div className="col">
                ...
                <div className="col">
                    <div className="card h-100 text-dark bg-light shadow-sm border-0">
                        ...
                        <div className="card-body pt-0">
                            ...
                            <Link to="/admin/products" className="text-dark text-decoration-none small">View Details &rarr;</Link>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card h-100 text-dark bg-light shadow-sm border-0">
                        ...
                        <div className="card-body pt-0">
                            ...
                            <Link to="/admin/users" className="text-dark text-decoration-none small">View Details &rarr;</Link>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card h-100 text-dark bg-light shadow-sm border-0">
                        ...
                        <div className="card-body pt-0">
                            ...
                            <Link to="/admin/products" className="text-dark text-decoration-none small">Restock Now &rarr;</Link>
                        </div>
                    </div>
                </div>
            </div>
